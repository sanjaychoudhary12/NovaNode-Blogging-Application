...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : NovaNode",
				"This project is developed by Sanjay Kumar", "1.0", "Terms of Service",
				new Contact("Sanjay", "https://github.com/sanjaychoudhary12", "rudraroop.33@gmail.com"),
